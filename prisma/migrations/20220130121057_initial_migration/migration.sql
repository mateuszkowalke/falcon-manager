...
CREATE TABLE "falcons" (
    ...
    "width_young" INTEGER NOT NULL,
    "length_young" INTEGER NOT NULL,
    "weight_young" INTEGER NOT NULL,
    "width_old" INTEGER NOT NULL,
    "length_old" INTEGER NOT NULL,
    "weight_old" INTEGER NOT NULL,
    "notes" TEXT NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
    "breeding_project_id" INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE "falcons" ADD CONSTRAINT "falcons_father_fkey" FOREIGN KEY ("father") REFERENCES "falcons"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "falcons" ADD CONSTRAINT "falcons_mother_fkey" FOREIGN KEY ("mother") REFERENCES "falcons"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
